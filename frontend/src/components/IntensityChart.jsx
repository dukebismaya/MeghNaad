...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-700 p-3 rounded-lg shadow-xl backdrop-blur-sm text-xs">
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-4 flex flex-col h-full">
      ...
      <div className="flex-1 min-h-[200px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            {/* Pressure Lines */}
            <Line yAxisId="pressure" type="monotone" dataKey="actual_pressure" name="Obs. Pressure" stroke="#38bdf8" strokeWidth={2} dot={{ r: 3, fill: "#38bdf8" }} connectNulls={false} />
            <Line yAxisId="pressure" type="monotone" dataKey="predicted_pressure" name="Pred. Pressure" stroke="#38bdf8" strokeWidth={2} strokeDasharray="5 5" dot={{ r: 3, fill: "#38bdf8" }} />
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-3 text-[10px] uppercase tracking-wider shrink-0">
        <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-sky-400 inline-block" /> Pressure (hPa)</span>
